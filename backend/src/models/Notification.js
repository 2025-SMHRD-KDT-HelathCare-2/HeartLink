...
// notificationSchema: 사용자/보호자에게 보낸 '알림' 기록을 저장하는 스키마
const notificationSchema = new Schema(
  {
    // analysisId: 어떤 분석 결과 때문에 발생한 알림인지 가리키는 ID. AnalysisResult 참조. 필수
    ...
    // sendStatus: 전송 결과. success(성공) / fail(실패). 필수
  ...
  // createdAt만 자동 기록, updatedAt은 생성하지 않음
...
// notificationSchema를 'Notification' 모델로 생성해 내보냄 (실제 컬렉션명은 'notifications')
