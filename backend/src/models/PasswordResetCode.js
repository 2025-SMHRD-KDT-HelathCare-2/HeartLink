...
// passwordResetCodeSchema: '비밀번호 재설정용 이메일 인증번호'를 임시 저장하는 스키마
//  - 비밀번호를 잊었을 때 이메일(Nodemailer + Gmail SMTP)로 보낸 인증번호를
//    잠깐 저장했다가 검증 후 자동 삭제(TTL)합니다.
...
// passwordResetCodeSchema를 'PasswordResetCode' 모델로 생성해 내보냄
//  - 실제 컬렉션명은 'passwordresetcodes'
