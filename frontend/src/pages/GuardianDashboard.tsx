...
const MEMBERS = [
  { id: 1, name: "김할머니", age: 74, relation: "어머니", lastMeasured: "오늘 09:32", riskLevel: "상" as const, riskScore: 78, unreadAlerts: 2 },
  { id: 2, name: "박할아버지", age: 81, relation: "아버지", lastMeasured: "어제 14:20", riskLevel: "중" as const, riskScore: 45, unreadAlerts: 0 },
  { id: 3, name: "이순자", age: 68, relation: "이모", lastMeasured: "2일 전 11:05", riskLevel: "하" as const, riskScore: 18, unreadAlerts: 0 },
];
