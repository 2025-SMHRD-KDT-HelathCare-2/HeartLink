  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-3 my-2">
        ...
        <span className="text-gray-400 font-bold text-tiny">또는</span>
        <div className="flex-1 h-px bg-gray-200" />
      </div>
      ...
      {providers.map((p) => (
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 rounded-xl border-2 font-bold transition-all text-[1.05rem] ${
            p.disabled
          ...
          style={{
            minHeight: 56,
            // 비활성화 시: 회색 처리 / 활성화 시: 원래 색상(브랜드 색이라 토큰 대상 아님)
